...
namespace Proxies\__CG__\SoftUniBlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \SoftUniBlogBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function addPost(\SoftUniBlogBundle\Entity\Article $article)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPost', [$article]);

        return parent::addPost($article);
    }
     ...
     * {@inheritDoc}
     */
    public function isAuthor(\SoftUniBlogBundle\Entity\Article $article)
    {
